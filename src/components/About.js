  ...
  return (
    <StyledDiv>
      ...
      <p className="pcentralised">
        ...
        <br />
        <img src={clairePic} alt="collie" width="50%" />
        She has qualifications in canine first aid, puppy and dog training,
        animal communication, and has a Dog Aggression Diploma. In addition she
        is a qualified &nbsp;
