...
const About = () => {
  return (
    <StyledDiv>
      ...
      <p>Claire's Canine Companions was established in 2010. <br/>
         They are a close knit team of Cambridgeshire based dog walkers and
        sitters, selected for their passion and expertise with dogs, lead by founder and namesake Claire. <br/>
<img src={autumn} alt="collie" width="50%" />
      
       Claire grew up on her parent's working farm, surrounded by animals. She fed
       and mucked out the chickens, geese and horses and took a special interest 
       in the training of gun dogs (prominently spaniels).
       <br/>
        
        She has qualifications in  canine first aid,
        puppy and dog training, animal communication, and has a Dog Aggression Diploma.
        In addition she is a qualified  &nbsp;
         <a href={"https://ttouch.com/"}>Tellington TTouch</a>, Canine Flow and Reiki practitioner.
        ...
        dogs whilst in our care, whether it being walks, daycare or boarding
        
         All boarding is done in the house rather than kennels so it is a very
        ...
        free and enjoying their dog lives
        
         Exciting new beginnings in 2021 Myself
        ...
        reliable.
      I am based in and around Cambridge centre and surrounding villages, Girton ,
